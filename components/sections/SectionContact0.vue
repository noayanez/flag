<template>
  <div
    id="Contact"
    :class="device ? 'container-devices' : 'uk-height-1-1'"
    class="uk-flex uk-flex-wrap uk-height-1-1 uk-width-1-1"
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          style="">
          <h3
            class="uk-text-uppercase title-contact-style uk-width-1-1 uk-text-center"
            style="text-align:left; color:white; font-weight: bold; padding: 15px 0px 15px 0px;">¿Quieres conectar<br> con tus clientes?</h3>
          <div
            class="description-contact uk-text-center"
            style="text-align:left;color:white;">Completa el formulario y comencemos a crear nuevas experiencias</div>
